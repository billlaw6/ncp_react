  ...
  public render() {
    ...
    return (
      <div>
        ...
        <Row>
          <Col span={6}>
            <Form.Item label="选择类型：" labelCol={{ span: 6 }} wrapperCol={{ span: 12 }} required={true}>
          ...
          <Col span={6}>
            <Form.Item label="输入对象名字：" labelCol={{ span: 8 }} wrapperCol={{ span: 12 }} required={true}>
              <Input
                placeholder="请输入对象的名字"
              />
            </Form.Item>
          </Col>
        </Row>
